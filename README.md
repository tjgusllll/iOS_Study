...
위와 같은 순서에 따라 실행하였을 때 콘솔에 출력되는 결과는 다음 이미지와 같다.<br><br>
<img src="./img/생명주기.png" width="1000" heigh="500"> <br><br><br>

#### 결과
앱이 실행, 종료되고 홈버튼을 사용하여 앱의 상태가 전환될 때는 앱 생명주기에 대한 함수들이 호출되었고, <br>
앱 실행 후 화면load와 앱의 화면이 전환되는 과정에서는 뷰 컨트롤러 생명주기에 대한 함수들이 호출되었음을 볼 수 있다.
